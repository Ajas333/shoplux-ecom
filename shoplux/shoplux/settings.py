"""
Django settings for shoplux project.
...
SECRET_KEY = 'django-insecure-dll8a9q(d9q=*4!3ap_u2mc4v4=zfsd*+%!#zuhh)lky8*fmj*'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'user_product_mng.context_processors.counter',
            ],
        },
    },
]

WSGI_APPLICATION = 'shoplux.wsgi.application'
